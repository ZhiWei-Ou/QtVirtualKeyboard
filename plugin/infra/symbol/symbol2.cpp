...
Keyboard_Symbol2::Keyboard_Symbol2(QPlatformInputContext *ctx, QWidget *parent)
    : KeyboardAbstractIC(ctx, parent), rect(Q_NULLPTR)
{
    QFile file(":assets/profiles/symbol2.json");
    ...
    for (auto item : layoutArray) {
        ...
        for (auto key : keysArray) {
            ...
            connect(b, &QPushButton::clicked, this, &Keyboard_Symbol2::keyClicked);
            hl->addWidget(b, w);
        }
...
Keyboard_Symbol2::~Keyboard_Symbol2()
{
}


void Keyboard_Symbol2::scale(float currentWidth)
{
...
void Keyboard_Symbol2::keyClicked()
{
